...
const Homepage2 = () => {
  return (
    <div className="flex flex-col lg:flex-row min-h-[60vh] bg-purple-100">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center py-12 lg:py-0">
        <div className="w-56 md:w-64 rounded-2xl overflow-visible shadow-2xl shadow-purple-400/40 font-sans transform scale-110 md:scale-125 lg:scale-100">
          {/* Top Section */}
          <div
